...
// Validate ../../src/app/api/docs/mcp/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/docs/mcp">> = Specific
  const handler = {} as typeof import("../../src/app/api/docs/mcp/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
